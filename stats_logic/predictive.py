...
def train_predictive_model(y, features, model_type='linear', feature_names=None):
    """
    ...
    try:
        ...
        if model_type == 'linear':
            ...
            # Feature Importance
            importance = dict(zip(feature_names, [round(abs(c), 4) for c in model.coef_]))
